  ...
  if (loading) {
    return (
      <section id="skills" className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative">        <motion.div
        ...
        >        <motion.h2 
          ...
          transition={{ duration: 0.6 }}
        >
          <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Technical Arsenal</span>
        </motion.h2>
